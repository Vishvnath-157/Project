...
def outputs(request):
    ...
    def generate_access_token(auth_code, client_id, secret_key):
        appSession = accessToken.SessionModel(client_id=client_id, secret_key=secret_key,
    ...
    def main():
        ...
        symbol = ["NSE:LSIL-EQ", "NSE:ORTINLAB-EQ", "NSE:DISHTV-EQ", "NSE:SYNGENE-EQ", "NSE:PARSVNATH-EQ"]
        ...
        fs.keep_running()
    return render(request,'home.html',(Script: {script}, Ltp:{ltp}, High:{high}, Low:{low}, ltt:{ltt}")
