...
script_list = ["HDFCBANK-EQ","SBIN-EQ","INFY-EQ","ICICIBANK-EQ","AXISBANK-EQ","MARUTI-EQ","WIPRO-EQ","BHARTIARTL-EQ","ASIANPAINT-EQ","DIVISLAB-EQ","HDFC-EQ"]
exchange = "NSE"
quantity = int(1)
timeframe = "1"
from_date = "2022-07-10"
today = datetime.datetime.now().strftime('%Y-%m-%d') #"2022-09-29"
rsi_overbought = 80
rsi_oversold = 20
buy_traded_stock = []
sell_traded_stock = []
